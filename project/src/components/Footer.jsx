...
const Footer = () => {
  return (
    <footer className="min-h-96 bg-[#001a39] text-white flex flex-col justify-between p-4 pt-10 max-[595px]:flex-col max-[595px]:text-center">
      <div className="flex flex-row space-x-10 justify-center mt-10 max-[595px]:space-x-0 max-[1160px]:flex-col">
        ...
        <div className="flex flex-row space-x-10 justify-center max-[595px]:space-x-0 max-[595px]:flex-col">
          ...
          <div className="mb-8 font-oxanium cursor-default max-[595px]:mt-10 max-[595px]:flex-row max-[595px]:space-x-8 flex flex-col max-[595px]:justify-center">
            <a href="https://hackerspace-portfolio.vercel.app/about">
              <h2 className="text-xl mb-4 relative group text-xl hover:transition duration-300">
                About
                <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#e8f6ff] transition-all duration-300 group-hover:w-[60px]"></span>
              </h2>
            </a>
            ...
            <a href="https://hackerspace-portfolio.vercel.app/contact">
              <h2 className="text-xl mb-4 relative group text-xl hover:transition duration-300">
                Contact
                <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#e8f6ff] transition-all duration-300 group-hover:w-[75px]"></span>
              </h2>
            </a>
            <a href="https://hackerspace-portfolio.vercel.app/events">
              <h2 className="text-xl mb-4 relative group text-xl hover:transition duration-300">
                Timeline
                <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#e8f6ff] transition-all duration-300 group-hover:w-[80px]"></span>
              </h2>
            </a>
          </div>
      ...
      {/* Copyright Section */}
      <div className="text-center text-slate-600 font-oxanium relative ">
